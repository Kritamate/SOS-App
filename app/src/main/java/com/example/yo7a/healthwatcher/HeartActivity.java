...
public class HeartActivity extends AppCompatActivity implements OnItemSelectedListener, Observer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.heartble);
        Log.i("HeartActivity", "Starting Polar HR monitor main activity");
        DataHandler.getInstance().addObserver(this);

        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2) {

            Log.i("HeartActivity", "old device H7 disbled");
            h7 = true;
        }
     ...
     */
    public void listBT() {
        Log.d("HeartActivity", "Listing BT elements");
        if (searchBt) {
            ...
            if (!h7) {
                Log.d("HeartActivity", "Listing BTLE elements");
                final BluetoothAdapter.LeScanCallback leScanCallback = new BluetoothAdapter.LeScanCallback() {
                    public void onLeScan(final BluetoothDevice device, final int rssi, final byte[] scanRecord) {
                        if (!list.contains(device.getName() + "\n" + device.getAddress())) {
                            Log.d("HeartActivity", "Adding " + device.getName());
                            list.add(device.getName() + "\n" + device.getAddress());
                ...
                Thread scannerBTLE = new Thread() {
                    public void run() {
                        Log.d("HeartActivity", "Starting scanning for BTLE");
                        mBluetoothAdapter.startLeScan(leScanCallback);
                        try {
                            Thread.sleep(5000);
                            Log.d("HeartActivity", "Stoping scanning for BTLE");
                            mBluetoothAdapter.stopLeScan(leScanCallback);
                        } catch (InterruptedException e) {
                            Log.e("HeartActivity", "ERROR: on scanning");
                        }
                    }
                };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) { //close connection
            ...
            Log.i("HeartActivity", "opening about");
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
        ...
        if (arg2 != 0) {
            ...
            if (!h7 && ((BluetoothDevice) pairedDevices.toArray()[DataHandler.getInstance().getID() - 1]).getName().contains("H7") && DataHandler.getInstance().getReader() == null) {
                ...
                Log.i("HeartActivity", "Starting h7");
                ...
                Log.i("HeartActivity", "Starting normal");
    ...
    public void connectionError() {
        ...
        Log.w("HeartActivity", "Connection error occured");
        if (menuBool) {//did not manually tried to disconnect
            Log.d("HeartActivity", "in the app");
            menuBool = false;
            final HeartActivity ac = this;
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (!h7) {
                        ...
                        Log.w("HeartActivity", "starting H7 after error");
                        DataHandler.getInstance().setReader(null);
                        ...
                        Log.w("HeartActivity", "Starting normal after error");
                        DataHandler.getInstance().setH7(null);
    ...
    public void onStop() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app URL is correct.
                Uri.parse("android-app://com.example.yo7a.healthwatcher/http/host/path")
        );
    ...
    public void onBackPressed() {
        Intent i = new Intent(HeartActivity.this, Primary.class);
        startActivity(i);
        finish();
        super.onBackPressed();
    }
